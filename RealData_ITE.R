## Golbal Args
#setwd("C:/Users/ELSAID/Dropbox/Elsayed_Mun/Second Project/Real Data/Simulation")
rm(list=ls())
...
n0t <- Nsample0[1]
#n0test <- 60         # total size for prediction (100)
...
## BMPWT and BDPFNBMD and BDPINBMD

# load("BMPWT_BDPFNBMD_BDPINBMD.RData")
# x1 <- BMPWT_BDPFNBMD_BDPINBMD$X1
# x2 <- BMPWT_BDPFNBMD_BDPINBMD$X2
# x3 <- BMPWT_BDPFNBMD_BDPINBMD$X3
# Y0 <- BMPWT_BDPFNBMD_BDPINBMD$Y

# Beta01 <-  c(0.0002,0.324,0.596)
# Beta02 <-  c(0.0011,0.417,0.418)
# Beta0 <- rbind(Beta01,Beta02)
# pi0 <- c(0.85,0.15)
# sigma0 <- c(0.000729,0.000625)
...
# Beta0 <- rbind(Beta01,Beta02)
# pi0 <- c(0.88,0.12)
# sigma0 <- c(0.033,0.004)

##*************************************************
## BMPWT and BMPWAIST with corr = 0.87

# load("BMPWT_BMPWAIST.RData")
# x1 <- BMPWT_BMPWAIST$X1
# x2 <- BMPWT_BMPWAIST$X2
# Y0 <- BMPWT_BMPWAIST$Y
# 
# Beta01 <-  c(0.015,0.003)
# Beta02 <-  c(-0.0003,0.006)
# Beta0 <- rbind(Beta01,Beta02)
# pi0 <- c(0.2,0.8)
# sigma0 <- c(0.0144,0.0121)


##***********************************************


## Starting point as a the same true parameter
...
# Beta01 <-  c(1,3,5)
# Beta02 <-  c(1.37,1.0008,1.0016)
# Beta0 <- rbind(Beta01,Beta02)
# x=matrix(c(1,32.8,99.7),nrow=1)
# 
# P_j <- dnorm(1.152 ,x%*%Beta0[1,],sqrt(1))
...
{
  ## intialization for prediction (p0+1) means the number of indep variables + response variable
...
save(MSE_Result,file="mse_size60_Ite.RData")
save(pre,file="test_size60_Ite.RData")
